...
Para probar los algoritmos de interpolación y la aplicación, se utilizarán datos de la web [Red Eléctrica](https://www.ree.es/). Esta web proporciona una API que permite acceder a base de datos de Red Eléctrica y que contiene entre otra mucha información, el histórico de demandas reales.
